...
class NaiveBayes:
    ...
    def _find_likelihoods_log(self, word_freq, alpha):
        total_tokens = sum(word_freq.values())
        denom = total_tokens + alpha * len(word_freq) 
    ...
    def train(self, df, alpha=1.0, spam_threshold=0.5):
        ...
        self.lk_tokens_ham = self._find_likelihoods_log(token_freqs_ham, alpha)
        self.lk_tokens_spam = self._find_likelihoods_log(token_freqs_spam, alpha)
